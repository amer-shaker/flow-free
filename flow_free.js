...
function handleLineConnectors() {
    ...
    $(".cell").click(function (event) {
        ...
        if (typeof cellColorValue !== "undefined" && typeof lineConnectorBackgroundTempColor === "undefined" && typeof color !== "undefined" && color != cellColorValue) {

            //To rest the array
            for (var i = 0; i < cellClicked.length; i++) {
                cellClicked[i].cellClicked = 0;
            }
